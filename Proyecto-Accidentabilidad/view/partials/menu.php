            ...
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="manualMenu">
                        <ul class="nav nav-collapse">
                            <?php if (Permisos::hasPermissionById(10)): ?>
                                <li><a href="<?php echo getUrl('Manual','ManualU','getList'); ?>">
                                <span class="sub-item">Manual usuario</span></a></li>
                            <?php endif; ?>

                            <?php if (Permisos::hasPermissionById(11)): ?>
                                <li><a href="<?php echo getUrl('Manual','ManualS','getList'); ?>">
                                <span class="sub-item">Manual se&ntilde;alizaci&oacute;n</span></a></li>
                            <?php endif; ?>

                            <?php if (Permisos::hasPermissionById(24)): ?>
                                <li><a href="<?php echo getUrl('Manual','ManualT','getList'); ?>">
                                <span class="sub-item">Manual t&eacute;cnico</span></a></li>
                            <?php endif; ?>

                            <?php if (Permisos::hasPermissionById(25)): ?>
                                <li><a href="<?php echo getUrl('Manual','ManualI','getList'); ?>">
                                <span class="sub-item">Manual instalaci&oacute;n</span></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </li>
