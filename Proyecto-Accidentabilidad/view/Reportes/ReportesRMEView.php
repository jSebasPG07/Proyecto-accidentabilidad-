<div class="mt-3">
    <h3 class="display-3">Solicitud reductor en mal estado</h3>
</div>
...
<form action="<?php echo getUrl('Reportes', 'ReportesRME', 'postCreate'); ?>"
    ...
    <div class="row mt-5">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="tipodano" name="tipodano"
                   placeholder="Ej: deformado, partido, suelto">
        </div>
